...
from d_mindformer.models.d_mindformer_out_trans_final_merge_change2 import DecisionMindformer
...
if __name__ == "__main__":
    ...
    experiment("ACT-out-trans-finial-merge-change", variant=vars(args))
