...
from d_mindformer.models.d_mindformer_out_trans_merge import DecisionMindformer
...
def experiment(
    ...
    if log_to_wandb:
        ...
        wandb.init(
            ...
            project="Inference-transformer-2000-step-walker2d",
            config=variant,
        )
...
if __name__ == "__main__":
    ...
    experiment("ACT-out-trans-merge", variant=vars(args))
